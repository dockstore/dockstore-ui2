  ...
  describe('manually register an Amazon ECR tool', function() {
    it("register tool", function() {
      ...
      cy
        ...
        .type('test.dkr.ecr.test.amazonaws.com')
      ...
      cy
        .get('#tool-path')
        .should('contain', 'test.dkr.ecr.test.amazonaws.com/testnamespace/testname')
      ...
      cy
        ...
        // cy
        // .get('#tool-path')
        // .should('not.contain', 'test.dkr.ecr.test.amazonaws.com/testnamespace/testname')
    });
