...
describe('search table items per page', () => {
  ...
  it('tool items per page', () => {
    ...
    cy.get('[data-cy=search-entry-table-paginator] mat-form-field').contains(10).should('be.visible');
    cy.get('[data-cy=search-entry-table-paginator] mat-form-field').click();
