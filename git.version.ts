...
.subscribe(([revision, tag]) => {
    console.log(`tag: '${tag}', version: '${process.env.npm_package_config_wsv}', revision: '${revision}'`);

    const content = '// this file is automatically generated by git.version.ts script\n' +
      `export const versions = {tag: '${tag}', version: '${process.env.npm_package_config_wsv}', revision: '${revision}'};\n`;
