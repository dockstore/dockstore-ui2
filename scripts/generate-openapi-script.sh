...
java -jar openapi-generator-cli.jar generate -i ${PATH}/swagger.yaml -l typescript-angular -o src/app/shared/swagger -c swagger-config.json
java -jar openapi-generator-cli.jar generate -i ${PATH}/openapi.yaml -l typescript-angular -o src/app/shared/openapi -c swagger-config.json
