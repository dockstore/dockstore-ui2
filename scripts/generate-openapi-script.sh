...
java -jar openapi-generator-cli.jar generate -i ~/dockstore/dockstore-webservice/src/main/resources/openapi3/openapi.yaml -l typescript-angular -o src/app/shared/openapi -c swagger-config.json
