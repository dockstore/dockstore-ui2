...
java -jar openapi-generator-cli.jar generate -i https://raw.githubusercontent.com/dockstore/dockstore/feature/2348/awsLogs/dockstore-webservice/src/main/resources/swagger.yaml -l typescript-angular -o src/app/shared/swagger -c swagger-config.json
