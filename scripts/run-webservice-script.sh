...
java -jar /Users/natalieperez/Projects/dockstore/dockstore-webservice/target/dockstore-webservice-1.7.0-beta.3-SNAPSHOT.jar db migrate -i 1.5.0,1.6.0,1.7.0,add_service_1.7.0,alter_test_user_1.7.0 travisci/web.yml
