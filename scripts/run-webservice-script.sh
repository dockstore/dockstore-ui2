...
psql -h localhost -c 'create database cypress_webservice with owner = dockstore;' -U postgres
psql -h localhost -f test/${DB_DUMP:-db_dump.sql} cypress_webservice -U postgres
...
java -jar dockstore-webservice.jar server test/web.yml
