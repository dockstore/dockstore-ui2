...
# Uncomment this to use the CircleCI jar
 JAR_PATH="https://7338-33383826-gh.circle-artifacts.com/0/tmp/artifacts/dockstore-webservice-1.11.0-alpha.1-SNAPSHOT.jar"
...
java -jar dockstore-webservice.jar db migrate -i 1.5.0,1.6.0,1.7.0,add_service_1.7.0,1.8.0,1.9.0,1.10.0,alter_test_user_1.11.0 travisci/web.yml
