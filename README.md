...
For a production build, you will need to install Nginx. 
...
```
Use `npm run build.prod` for a production build and start it with `nginx`. localhost:4200 should be available immediately.
