...
export class SearchComponent implements OnInit, OnDestroy {
  ...
  /**
   * Handle the popstate events generated by browser back/forward button actions.
   * If the destination page is also a search page, navigate to an invalid url, then
   * back to the destination page again, causing this component to reinitiatize, which
   * terminates the previous search and loads the destination page search, preventing
   * the overlapping state changes that cause the self-DOS behavior.
