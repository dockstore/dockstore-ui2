...
export class EmailService {
   ...
   */
  public composeRequestAccessEmail(tool: ExtendedDockstoreTool, username: string): string {
    ...
    const body = this.getRequestEmailBody(tool.tool_path, tool.imgProvider, username);
