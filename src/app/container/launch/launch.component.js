...
var LaunchComponent = (function (_super) {
    __extends(LaunchComponent, _super);
    function LaunchComponent(launchService, containerService) {
        var _this = _super.call(this) || this;
        _this.launchService = launchService;
        _this.containerService = containerService;
        return _this;
    }
    LaunchComponent.prototype.getDescriptors = function (currentVersion) {
        return this.containerService.getDescriptors(this.versions, this.default);
    };
    LaunchComponent.prototype.reactToDescriptor = function () {
        this.changeMessages(this.path, this.currentVersion.name);
    };
    LaunchComponent.prototype.changeMessages = function (toolPath, versionName) {
...
__decorate([
    core_1.Input()
], LaunchComponent.prototype, "path", void 0);
