...
const APP_ROUTES: Routes = [
  ...
  { path: 'search-containers', redirectTo: 'search' },
  { path: 'containers', redirectTo: 'search' },
  { path: 'tools', redirectTo: 'search' },
  { path: 'workflows', redirectTo: 'search' },
  { path: 'search-workflows', redirectTo: 'search' },
