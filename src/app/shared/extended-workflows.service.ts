...
export class ExtendedWorkflowsService extends WorkflowsService {
  /**
    ...
    public getWorkflowZip(workflowId: number, workflowVersionId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public getWorkflowZip(workflowId: number, workflowVersionId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public getWorkflowZip(workflowId: number, workflowVersionId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
