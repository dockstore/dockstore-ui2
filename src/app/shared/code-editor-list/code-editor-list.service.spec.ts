...
describe('CodeEditorListService', () => {
  ...
  it('should be able to know if path is a primary descriptor', () => {
    ...
    const secondaryCWLFile = { content: '', absolutePath: '/.cwl', path: '/Dockstore.cwl', type: SourceFile.TypeEnum.DOCKSTORECWL };
    const primaryWDLFile = { content: '', absolutePath: '/.cwl', path: '/Dockstore.wdl', type: SourceFile.TypeEnum.DOCKSTOREWDL };
