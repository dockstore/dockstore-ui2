...
export class UserQuery extends Query<UserState> {
  ...
  isCurator$: Observable<boolean> = this.select(state => state.user.curator ? state.user.curator : null);
  isAdmin$: Observable<boolean> = this.select(state => state.user.isAdmin ? state.user.isAdmin : null);
