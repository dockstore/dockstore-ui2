...
describe('Service: version-modal.service.ts', () => {
  ...
  // TODO: https://ucsc-cgl.atlassian.net/browse/SEAB-7158 someone more well versed than me should investigate whether this is known breakage with newer node versions
