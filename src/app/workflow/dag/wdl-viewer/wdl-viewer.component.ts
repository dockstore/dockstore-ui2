 ...
 */
// Only Classic view available for now because pipeline-builder relies on an older version of lodash.
// https://ucsc-cgl.atlassian.net/browse/SEAB-1402 and no support for WDL 1.0
// Once https://github.com/epam/pipeline-builder/issues/57 is resolved, wdl-viewer can be uncommented again.
// Search for "ALLOW WDL VIEWER AGAIN"
