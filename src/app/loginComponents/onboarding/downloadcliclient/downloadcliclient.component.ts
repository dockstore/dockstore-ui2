...
------------------------------
Setup our Dockstore CLI application in order to test workflows from the command line for [local development](https://docs.dockstore.org/en/stable/launch-with/launch.html#dockstore-cli), [validate .dockstore.yml files](https://docs.dockstore.org/en/stable/advanced-topics/dockstore-cli/yaml-command-line-validator-tool.html) for registering tools and workflows,
run scripts or interact programmatically against Dockstore APIs, and [run workflows via the GA4GH WES standard](https://docs.dockstore.org/en/stable/advanced-topics/wes/wes-agc-tutorial.html) in platforms such as AWS AGC.
